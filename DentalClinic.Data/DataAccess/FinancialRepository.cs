...
public class FinancialRepository
{
    ...
    public void AddDoctorCommissionExpense(decimal amount, string description, int sessionId, int paymentId, int doctorUserId)
    {
        const string sql = @"
    ...
    public List<DoctorStatRow> GetDoctorStatistics()
    {
        const string sql = @"
            SELECT u.UserID, u.FullName,
                   ...
                   ISNULL(SUM(s.PaidAmount), 0) AS GrossIncome
            FROM Users u
