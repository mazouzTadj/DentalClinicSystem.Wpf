...
public partial class LoginWindow : Window
{
    ...
    public LoginWindow()
    {
        ...
        var remembered = LoginPreferences.LoadRememberedUsername("Doctor");
        if (!string.IsNullOrWhiteSpace(remembered))
        {
            ...
            var rememberedPassword = LoginPreferences.LoadRememberedPassword("Doctor");
    ...
    private void LoginButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            var rememberPassword = RememberMeCheckBox.IsChecked == true && RememberPasswordCheckBox.IsChecked == true
                ? password
                : null;
            LoginPreferences.SaveRememberedCredentials("Doctor", rememberUsername, rememberPassword);
            DialogResult = true;
            Close();
        }
        catch (Exception ex)
